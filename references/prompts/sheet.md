...
Generate a printable question sheet:
...
For each question, leave space for handwritten answers.

Format this as a clean, printable document suitable for taking into
owner interviews.
